...
class Generator(keras.utils.Sequence):
    ...
    def resize_image(self, image):
        ...
        if self.no_resize:
            ...
            #
            return resize_image(image, tar_height=self.image_min_side, tar_width=self.image_max_side)
    ...
    def preprocess_group_entry(self, image, annotations):
        ...
        image_scale = np.array([image_scale[1],image_scale[0],image_scale[1],image_scale[0]])
        image_scale = np.reshape(image_scale,(1,4))
    ...
    def __getitem__(self, index):
        ...
        group = self.groups[index]
        inputs, targets = self.compute_input_output(group)
        return inputs, [targets[0], targets[1], targets[0], targets[1], targets[0], targets[1]]